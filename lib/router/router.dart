...
@MaterialAutoRouter(
  ...
  routes: <AutoRoute>[
    ...
    AutoRoute<String>(page: GroupDetailPage, path: '/groupDetail',guards: [AuthGuard]),
    ...
    AutoRoute<String>(page: EventListingPage, path: '/eventListing',guards: [AuthGuard]),
    AutoRoute<String>(page: EventListingDetailPage, path: '/eventListingDetail',guards: [AuthGuard]),

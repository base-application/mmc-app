                ...
                Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      const Text('Cecelia', style: TextStyle(fontSize: 18, color: Color(0xFF013B7B), fontWeight: FontWeight.w500),),
                      const SizedBox(height: 8,),
                      Text('Product Manager', style: TextStyle(fontSize: 13, color: Colors.black87.withAlpha(180), fontWeight: FontWeight.w400),),
                      const SizedBox(height: 14,),
                      const Text('6,000', style: TextStyle(fontSize: 24, color: Color(0xFF013B7B), fontWeight: FontWeight.w500),),
                    ],
                  ),
                ),
                Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      const SizedBox(height: 18,),
                      const Text('Cecelia Tay', style: TextStyle(fontSize: 22, color: Color(0xFF013B7B), fontWeight: FontWeight.w500),),
                      const SizedBox(height: 8,),
                      Text('Product Manager', style: TextStyle(fontSize: 14, color: Colors.black87.withAlpha(180), fontWeight: FontWeight.w400),),
                      const SizedBox(height: 14,),
                      const Text('8,000', style: TextStyle(fontSize: 24, color: Color(0xFF013B7B), fontWeight: FontWeight.w500),),
                    ],
                  ),
                ),
                Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      const SizedBox(height: 18,),
                      const  Text('Cec', style: TextStyle(fontSize: 18, color: Color(0xFF013B7B), fontWeight: FontWeight.w500),),
                      const SizedBox(height: 8,),
                      Text('Product Manager', style: TextStyle(fontSize: 13, color: Colors.black87.withAlpha(180), fontWeight: FontWeight.w400),),
                      const SizedBox(height: 14,),
                      const  Text('5,000', style: TextStyle(fontSize: 24, color: Color(0xFF013B7B), fontWeight: FontWeight.w500),),
                    ],
                  ),
                ),
                const SizedBox(width: 4,),
            ...
            Container(
              ...
              child: Row(
                ...
                children: [
                  ...
                  const Text('4,000', style: TextStyle(fontSize: 24, color: Color(0xFF013B7B), fontWeight: FontWeight.w500),),
                ],
              ),
            ),

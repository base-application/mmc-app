          ...
          children: [
            Expanded(child: Container(
              ...
              child: Row(
                ...
                children: [
                  Text('Total refer', style: const TextStyle(fontSize: 15, fontWeight: FontWeight.w500, color: Color(0xFF0B43A0),),),
            ...
            Expanded(child: Container(
              ...
              child: Row(
                mainAxisSize: MainAxisSize.min,
                children: [
                  Text('Total support', style: const TextStyle(fontSize: 15, fontWeight: FontWeight.w500, color: Color(0xFF0B43A0),),),
                  const SizedBox(width: 6,),

  ...
  T? asT<T extends Object?>(dynamic value) {
	...
	static M? _fromJsonSingle<M>(Map<String, dynamic> json) {
		...
		if(type == (CourseDetailEntity).toString()){
			return CourseDetailEntity.fromJson(json) as M;
		}
		if(type == (CourseDetailParentCourseDetail).toString()){
			return CourseDetailParentCourseDetail.fromJson(json) as M;
		}
		if(type == (CourseDetailVideos).toString()){
			return CourseDetailVideos.fromJson(json) as M;
		}
		if(type == (CourseDetailFiles).toString()){
			return CourseDetailFiles.fromJson(json) as M;
		}
		if(type == (CourseDetailSchedules).toString()){
			return CourseDetailSchedules.fromJson(json) as M;
		}
		...
		if(type == (MasterCategoryEntity).toString()){
			return MasterCategoryEntity.fromJson(json) as M;
		}
		if(type == (MasterCategoryCourses).toString()){
			return MasterCategoryCourses.fromJson(json) as M;
		}
  ...
  //list is returned by type
	static M? _getListChildType<M>(List<Map<String, dynamic>> data) {
		...
		if(<CourseDetailEntity>[] is M){
			return data.map<CourseDetailEntity>((Map<String, dynamic> e) => CourseDetailEntity.fromJson(e)).toList() as M;
		}
		if(<CourseDetailParentCourseDetail>[] is M){
			return data.map<CourseDetailParentCourseDetail>((Map<String, dynamic> e) => CourseDetailParentCourseDetail.fromJson(e)).toList() as M;
		}
		if(<CourseDetailVideos>[] is M){
			return data.map<CourseDetailVideos>((Map<String, dynamic> e) => CourseDetailVideos.fromJson(e)).toList() as M;
		}
		if(<CourseDetailFiles>[] is M){
			return data.map<CourseDetailFiles>((Map<String, dynamic> e) => CourseDetailFiles.fromJson(e)).toList() as M;
		}
		if(<CourseDetailSchedules>[] is M){
			return data.map<CourseDetailSchedules>((Map<String, dynamic> e) => CourseDetailSchedules.fromJson(e)).toList() as M;
		}
		...
		if(<MasterCategoryEntity>[] is M){
			return data.map<MasterCategoryEntity>((Map<String, dynamic> e) => MasterCategoryEntity.fromJson(e)).toList() as M;
		}
		if(<MasterCategoryCourses>[] is M){
			return data.map<MasterCategoryCourses>((Map<String, dynamic> e) => MasterCategoryCourses.fromJson(e)).toList() as M;
		}
